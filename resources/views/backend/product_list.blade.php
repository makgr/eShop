                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img class="img_thumbnail" src="{{URL::asset('uploads/thumbs/'.$row->product_image)}}">
                                            </td>
                                            <td>
                                                <a class="btn btn-primary" href="{{url('product-edit/'.$row->product_id)}}">Edit</a>
                                                 <a class="btn btn-danger" href="{{url('product-delete/'.$row->product_id)}}">Delete</a>
